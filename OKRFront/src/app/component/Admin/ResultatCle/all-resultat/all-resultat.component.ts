...
@Component({
  selector: 'app-all-resultat',
  templateUrl: './all-resultat.component.html',
  styleUrls: ['./all-resultat.component.css']
})
export class AllResultatComponent implements OnInit {
